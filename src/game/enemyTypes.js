...
export const ENEMY_TYPES = {
  normal: { radius: 12, hp: 20, speed: 60, damage: 10, color: '#ff5470', unlockWave: 1, weight: 3 },
  fast: { radius: 9, hp: 10, speed: 130, damage: 8, color: '#ffcf4d', unlockWave: 2, weight: 2 },
  tanky: { radius: 18, hp: 55, speed: 38, damage: 18, color: '#9b5de5', unlockWave: 3, weight: 1 },
}
